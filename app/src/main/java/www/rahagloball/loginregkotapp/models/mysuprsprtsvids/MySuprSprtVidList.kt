...
class MySuprSprtVidList : Serializable {
    @SerializedName("id")
    @Expose
    var id: String? = null
    ...
    @Expose
    var comments: List<MySuprSprtComment>? = null

    @SerializedName("views")
    @Expose
    var views: List<MySuprSprtView>? = null

    @SerializedName("votes")
    @Expose
    var votes: List<MySuprSprtVote>? = null

    @SerializedName("channel")
    @Expose
    var channel: MySuprSprtChannel? = null
}