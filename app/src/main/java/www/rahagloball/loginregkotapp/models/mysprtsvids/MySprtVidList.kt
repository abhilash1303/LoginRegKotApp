...
class MySprtVidList : Serializable {
    @SerializedName("id")
    @Expose
    var id: String? = null
    ...
    @Expose
    var comments: List<MySprtCmnts>? = null

    @SerializedName("views")
    @Expose
    var views: List<MySprtViews>? = null

    @SerializedName("votes")
    @Expose
    var votes: List<MySprtVotes>? = null

    @SerializedName("channel")
    @Expose
    var channel: MySprtChannel? = null
}