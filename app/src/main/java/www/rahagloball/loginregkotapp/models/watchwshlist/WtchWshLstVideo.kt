...
class WtchWshLstVideo : Serializable {
    @SerializedName("id")
    @Expose
    var id: String? = null
    ...
    @Expose
    var comments: List<WtchWshLstComment>? = null

    @SerializedName("views")
    @Expose
    var views: List<WtchWshLstView>? = null

    @SerializedName("votes")
    @Expose
    var votes: List<WtchWshLstVote>? = null

    @SerializedName("channel")
    @Expose
    var channel: WtchWshLstChannel? = null
}