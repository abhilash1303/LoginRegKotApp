...
class DatumCd {
    ...
    @Expose
    private var course_tags: Any? = null
    ...
    @Expose
    var include: List<IncludeItemCd>? = null

    @SerializedName("whatlearns")
    @Expose
    var whatlearns: List<WhatlearnsCd>? = null

    @SerializedName("review")
    @Expose
    var review: List<ReviewCd>? = null
    var courseTags: List<String>?
        get() = if (course_tags is String) {
            val tags: MutableList<String> =
                ArrayList()
            tags.add(course_tags as String)
            tags
        } else {
            course_tags as List<String>?
        }
        set(courseTags) {
