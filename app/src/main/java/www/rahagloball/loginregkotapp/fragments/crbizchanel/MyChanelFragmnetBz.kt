...
class MyChanelFragmnetBz : Fragment(), View.OnClickListener {
    ...
    //
    //    CardView card_view_ssc,card_view_ddssc,card_viewd_ssc;
    ...
    val milestiones: Unit
        get() {
            ...
            RetrofitClient.getClient().getmilestnbz(url, "application/json", "Bearer $token")
                ?.enqueue(object : GlobalCallback<MilestoneBzPojo?>(my_sprtrss) {
