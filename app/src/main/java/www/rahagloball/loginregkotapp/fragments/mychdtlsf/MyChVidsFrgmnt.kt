...
import www.rahagloball.loginregkotapp.activities.TSprtrChnlPrfl
...
class MyChVidsFrgmnt : Fragment() {
    ...
    override fun onCreateView(
        ...
        val activity: TSprtrChnlPrfl? = activity as TSprtrChnlPrfl?
        ChCtsIdSStr = activity?.getMyChDtls()
    ...
    private val vids: Unit
        get() {
            blur_reg1_cts?.visibility = View.VISIBLE
            val url: String = Configs.BASE_URL2 + "channel-videos/" + ChCtsIdSStr
                        ...
                        try {
                            ...
                            if (catggryList != null) {
                                if (catggryList.isEmpty()) {
                                    ...
                                    adapter_cuties_list =
                                        activity?.let { AllVidChListAdapter(catggryList, it) }
