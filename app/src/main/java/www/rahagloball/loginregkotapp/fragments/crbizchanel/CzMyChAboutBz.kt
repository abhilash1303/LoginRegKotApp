...
import www.rahagloball.loginregkotapp.fragments.MyChDtlsBz
import www.rahagloball.loginregkotapp.fragments.crtrzone.MyCourseFrgmnt

class CzMyChAboutBz : Fragment() {
    ...
    override fun onCreateView(
        ...
        tab_1_ovrvw?.setOnClickListener(View.OnClickListener { v: View? ->
            updateTabContent(CrtsVideoFrgmntBz())
        ...
        tab_3_demogrfics?.setOnClickListener(View.OnClickListener { v: View? ->
            updateTabContent(CrtrCtsListFrgmntBz())
