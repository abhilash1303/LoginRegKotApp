...
class TrndVidsStackFrgmnt  //    private PieChart pieChart;
    : Fragment() {
    ...
    override fun onCreateView(
        ...
        val viewexp: View = inflater.inflate(R.layout.ttltrndstck_layout, container, false)
