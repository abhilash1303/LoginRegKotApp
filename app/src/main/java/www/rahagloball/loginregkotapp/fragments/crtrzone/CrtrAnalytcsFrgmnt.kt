...
import www.rahagloball.loginregkotapp.fragments.anlytcs.TabGndrFragment
import www.rahagloball.loginregkotapp.fragments.anlytcs.TabOvrVwFragment

class CrtrAnalytcsFrgmnt : Fragment() {
    ...
    override fun onCreateView(
        ...
        updateTabContent(TabOvrVwFragment())
        ...
        tab_2_gnder?.setOnClickListener(View.OnClickListener { v: View? ->
            updateTabContent(TabGndrFragment())
