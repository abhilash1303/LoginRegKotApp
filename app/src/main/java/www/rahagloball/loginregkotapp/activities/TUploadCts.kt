...
class TUploadCts constructor() : AppCompatActivity() {
    ...
    var catgry_list: ArrayList<String> = ArrayList()
    var subcatgry_list: ArrayList<String> = ArrayList()
    var vidcategry: ArrayList<String> = ArrayList()
    ...
    var cutiorVid: Array<String> = arrayOf("cuties")
    ...
    protected override fun onCreate(savedInstanceState: Bundle?) {
        ...
        context = this@TUploadCts
        manager = SessionManager()
        token = manager?.getPreferences(this@TUploadCts, Constants.USER_TOKEN_LRN)
...
//                            selectedVideoUri = videoUri;
        ...
        vid_prevw_imgg_btn!!.setOnClickListener(View.OnClickListener { v: View? -> pickImage() })
        upld_videoo!!.setOnClickListener(View.OnClickListener({ v: View? -> pickVideo() }))
    ...
    private fun tuplodvideo() {
        try {
            ...
            map!!.put("category", RequestBody.create(MediaType.parse("text/plain"), catgrt_id_str))
            map!!.put(
                "sub_category",
                RequestBody.create(MediaType.parse("text/plain"), subcat_id_str)
            )
            map!!.put("channel_type", RequestBody.create(MediaType.parse("text/plain"), selch_str))
            ...
            RetrofitClient.getClient().upload_viddnew(
                ...
                ?.enqueue(object : GlobalCallback<String?>(vid_prevw_imgg) {
                   override fun onResponse(call: Call<String?>, response: Response<String?>) {
                        try {
                            val tcrs_res: String ? = response.body()?.toString()
                            if (tcrs_res != null) {
                                if (tcrs_res.contains("1")) {
                                    ...
                                    Toast.makeText(this@TUploadCts, "Failed", Toast.LENGTH_SHORT).show()
                                }
                            }
                        } catch (e: Exception) {
                ...
                for (i in 0 until j.length()) {
                    try {
                        ...
                        for (k in 0 until vidcategry.size) {
                            val countryName = json.getString(Configs.KEY_VIDCTRGYNAME)
...
//                        }
            ...
            val dataAdapter5: ArrayAdapter<String> =
                ArrayAdapter<String>(this@TUploadCts, R.layout.custom_spiner_layout, vidcategry)
...
//                        }
        ...
        //
            ...
            val dataAdapter5: ArrayAdapter<String> =
                ArrayAdapter<String>(this@TUploadCts, R.layout.custom_spiner_layout, catgry_list)
            dataAdapter5.setDropDownViewResource(R.layout.custom_spiner_layout)
...
//                            val h: KeyPairBoolData = KeyPairBoolData()
//                            h.setId(k + 1)
//                            h.setName(subcatgry_list.get(k))
//                            h.setSelected(false)
//                            listArray0.add(h)
//                        }
                        //
        ...
        //
            ...
            val dataAdapter5: ArrayAdapter<String> =
                ArrayAdapter<String>(this@TUploadCts, R.layout.custom_spiner_layout, subcatgry_list)
            dataAdapter5.setDropDownViewResource(R.layout.custom_spiner_layout)
    ...
    companion object {
        private val TAG: String = "TUploadVid"
