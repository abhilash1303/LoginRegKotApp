...
abstract class Option<T : Any>(val name: String) {
    ...
    class Mode : Control<com.otaliastudios.cameraview.controls.Mode>(
        com.otaliastudios.cameraview.controls.Mode::class, "Mode"
    )

    class Engine : Control<com.otaliastudios.cameraview.controls.Engine>(
        com.otaliastudios.cameraview.controls.Engine::class, "Engine"
    ) {
        override fun set(
            view: CameraView,
            value: com.otaliastudios.cameraview.controls.Engine
        ) {
            if (view.isOpened) {
    ...
    class Flash : Control<com.otaliastudios.cameraview.controls.Flash>(
        com.otaliastudios.cameraview.controls.Flash::class, "Flash"
    )

    class WhiteBalance :
        Control<com.otaliastudios.cameraview.controls.WhiteBalance>(
            com.otaliastudios.cameraview.controls.WhiteBalance::class,
            "White Balance"
        )

    class Hdr : Control<com.otaliastudios.cameraview.controls.Hdr>(
        com.otaliastudios.cameraview.controls.Hdr::class, "HDR"
    )
    ...
    class Pinch :
        Gesture(com.otaliastudios.cameraview.gesture.Gesture.PINCH, "Pinch")

    class HorizontalScroll : Gesture(
        com.otaliastudios.cameraview.gesture.Gesture.SCROLL_HORIZONTAL,
        "Horizontal Scroll"
    )

    class VerticalScroll : Gesture(
        com.otaliastudios.cameraview.gesture.Gesture.SCROLL_VERTICAL,
        "Vertical Scroll"
    )

    class Tap :
        Gesture(com.otaliastudios.cameraview.gesture.Gesture.TAP, "Tap")

    class LongTap : Gesture(
        com.otaliastudios.cameraview.gesture.Gesture.LONG_TAP,
        "Long Tap"
    )
    ...
    class Grid : Control<com.otaliastudios.cameraview.controls.Grid>(
        com.otaliastudios.cameraview.controls.Grid::class, "Grid Lines"
    )
    ...
    class PictureFormat :
        Control<com.otaliastudios.cameraview.controls.PictureFormat>(
