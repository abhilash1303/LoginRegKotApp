...
import www.rahagloball.loginregkotapp.adapters.CrsSctnVidAdapter
...
class TCourseAddVideos constructor() : AppCompatActivity() {
    ...
    protected override fun onCreate(savedInstanceState: Bundle?) {
        ...
        context = this@TCourseAddVideos
        manager = SessionManager()
        token = manager?.getPreferences(this@TCourseAddVideos, Constants.USER_TOKEN_LRN)
        ...
        add_video_section?.setOnClickListener(View.OnClickListener { v: View? ->
            bundle = intent.extras
            crs_section_idd = bundle?.getString("section_title_id")
            val intent: Intent = Intent(this@TCourseAddVideos, SectionVideoActivity::class.java)
            intent.putExtra("section_title_idd", crs_section_idd)
            startActivity(intent)
        })
        allSctnVids
    }

    private val allSctnVids: Unit
        get() {
                 ...
                 override   fun onResponse(
                        ...
                        try {
                            ...
                            if (catggryList!!.isEmpty()) {
                                ...
                                adapter_imgs = CrsSctnVidAdapter(catggryList!!, this@TCourseAddVideos)
