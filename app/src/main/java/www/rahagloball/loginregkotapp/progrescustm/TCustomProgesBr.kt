...
class TCustomProgesBr : View {
    ...
    constructor(context: Context, attrs: AttributeSet?) : super(context, attrs) {
        init(context, attrs, 0, R.style.TCustomProgesBr)
    }
    ...
    constructor(context: Context, attrs: AttributeSet?, defStyleAttr: Int) : super(
        ...
        init(context, attrs, defStyleAttr, R.style.TCustomProgesBr)
    }
    ...
    private fun init(context: Context, attrs: AttributeSet?, defStyleAttr: Int, defStyleRes: Int) {
        ...
        val a: TypedArray = context.obtainStyledAttributes(
            attrs, R.styleable.TCustomProgesBr, defStyleAttr, defStyleRes
        )
        mMinWidth = a.getDimensionPixelSize(R.styleable.TCustomProgesBr_minWidth, mMinWidth)
        mMaxWidth = a.getDimensionPixelSize(R.styleable.TCustomProgesBr_maxWidth, mMaxWidth)
        mMinHeight = a.getDimensionPixelSize(R.styleable.TCustomProgesBr_minHeight, mMinHeight)
        mMaxHeight = a.getDimensionPixelSize(R.styleable.TCustomProgesBr_maxHeight, mMaxHeight)
        val indicatorName: String? = a.getString(R.styleable.TCustomProgesBr_indicatorName)
        mIndicatorColor = a.getColor(R.styleable.TCustomProgesBr_indicatorColor, Color.WHITE)
    ...
    fun setIndicator(indicatorName: String) {
        ...
        if (!indicatorName.contains(".")) {
            val defaultPackageName = Objects.requireNonNull(javaClass.getPackage()).name
    ...
    companion object {
        private const val TAG = "TCustomProgesBr"
        private val DEFAULT_INDICATOR = LineScalePulseOutIndicator()
