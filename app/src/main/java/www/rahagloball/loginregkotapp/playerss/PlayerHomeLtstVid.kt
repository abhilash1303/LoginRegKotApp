...
import www.rahagloball.loginregkotapp.models.ltstvids.LtstVidChannel
import www.rahagloball.loginregkotapp.models.ltstvids.LtstVidDatum
import www.rahagloball.loginregkotapp.models.ltstvids.LtstVidVote
...
class PlayerHomeLtstVid : AppCompatActivity(), SwipeInterface {
    ...
    protected override fun onCreate(savedInstanceState: Bundle?) {
        ...
        contextt = this@PlayerHomeLtstVid
        manager = SessionManager()
        token = manager?.getPreferences(this@PlayerHomeLtstVid, Constants.USER_TOKEN_LRN)
        suprt_hit_str = manager?.getPreferences(this@PlayerHomeLtstVid, Constants.SUPPORT_HIT)
...
//        audioManager = (AudioManager) getSystemService(AUDIO_SERVICE);
        ...
        saved_ivd_strrr = manager?.getPreferences(this@PlayerHomeLtstVid, Constants.VIDEO_SAVEEE)
        ...
        vid_speedddd?.setOnClickListener(View.OnClickListener { view: View? ->
            val builder = AlertDialog.Builder(this@PlayerHomeLtstVid)
...
//        dislike_filled = findViewById(R.id.dislike_filled);
        ...
        try {
            ...
            val video: LtstVidDatum = data?.getSerializable("videoData") as LtstVidDatum
            val votesItems: List<LtstVidVote>? = video.votes
            ...
            val channell: LtstVidChannel? = video.channel
            ...
            ll_ch_viewww?.setOnClickListener(View.OnClickListener { view: View? ->
                val intent = Intent(this@PlayerHomeLtstVid, ChannelProfileActivity::class.java)
...
//
                ...
                layoutManager = LinearLayoutManager(this@PlayerHomeLtstVid)
...
//                                blur_reg1.visibility = (View.GONE);
                        try {
                            ...
                            if (ss_stus != null) {
                                if (ss_stus.contains("1")) {
                                    ...
                                    mBottomSheetDialog =
                                        BottomSheetDialog(contextt as PlayerHomeLtstVid)
                                    mBottomSheetDialog?.setContentView(bottomSheetLayout!!)
                                    mBottomSheetDialog?.show()
                                }
                                    ...
                                    rankDialog =
                                        Dialog(this@PlayerHomeLtstVid, R.style.FullHeightDialog)
            ...
            ll_report_vid?.setOnClickListener { v: View? ->
                rankDialog = Dialog(this@PlayerHomeLtstVid, R.style.FullHeightDialog)
...
//                                    cfPaymentService.doPayment(PlayerHomeLtstVid.this, params, token, "PROD", "#174778", "#FFFFFF", false);
////                                    Intent intentpay = new Intent(PlayerHome.this, PlayerHome.class);
////                                    startActivity(intentpay);
//
//                                } else {
//                                    Toast.makeText(PlayerHomeLtstVid.this, "msg2" + response.body().getMessage(), Toast.LENGTH_SHORT).show();
//                                }
//                            } else {
//                                Toast.makeText(PlayerHomeLtstVid.this, "msg3" + response.body().getMessage(), Toast.LENGTH_SHORT).show();
//                            }
//
//
//                        } catch (Exception e) {
                    ...
                    try {
                        ...
                        if (catggryList != null) {
                            if (catggryList.isEmpty()) {
                                ...
                                adapter_vids_list =
                                    RelVidListAdapter(catggryList, this@PlayerHomeLtstVid)
...
//        String url = Configs.BASE_URL2 + "supports" + ch_idstr;
        ...
        RetrofitClient.getClient().hitsuppportt(chh_iddstr, "application/json", "Bearer $token")
            ?.enqueue(object : GlobalCallback<SupporrtPojo?>(title) {
                ...
                override fun onResponse(
                    ...
                    if (res != null) {
                        manager?.setPreferences(this@PlayerHomeLtstVid, Constants.SUPPORT_HIT, res)
                    }
                    if (res != null) {
                        if (res.contains("2")) {
    ...
    private fun liketoggle() {
        like_outlined!!.setOnTouchListener(View.OnTouchListener { v: View?, event: MotionEvent? -> false })
        like_filled!!.setOnTouchListener(View.OnTouchListener { v: View?, event: MotionEvent? -> false })
    }
