...
import www.rahagloball.loginregkotapp.models.mychvids.MyChVidChannel
import www.rahagloball.loginregkotapp.models.mychvids.MyChVidVote
...
class PlayerChVid : AppCompatActivity(), SwipeInterface {
    ...
    protected override fun onCreate(savedInstanceState: Bundle?) {
        ...
        contextt = this@PlayerChVid
        manager = SessionManager()
        token = manager!!.getPreferences(this@PlayerChVid, Constants.USER_TOKEN_LRN)
        suprt_hit_str = manager!!.getPreferences(this@PlayerChVid, Constants.SUPPORT_HIT)
...
//        audioManager = (AudioManager) getSystemService(AUDIO_SERVICE);
        ...
        saved_ivd_strrr = manager?.getPreferences(this@PlayerChVid, Constants.VIDEO_SAVEEE)
        ...
        vid_speedddd?.setOnClickListener(View.OnClickListener { view: View? ->
            val builder = AlertDialog.Builder(this@PlayerChVid)
...
//        }
        ...
        try {
            ...
            val video: MyChVideos = data?.getSerializable("videoData") as MyChVideos
            val votesItems: List<MyChVidVote>? = video.votes
            if (votesItems != null) {
            ...
            val channell: MyChVidChannel? = video.channel
            ...
            ll_ch_viewww?.setOnClickListener(View.OnClickListener { view: View? ->
                val intent = Intent(this@PlayerChVid, ChannelProfileActivity::class.java)
...
//
                ...
                layoutManager = LinearLayoutManager(this@PlayerChVid)
...
//                ll_super_spprt.visibility = (View.GONE);
                        ...
                        try {
                            ...
                            if (ss_stus != null) {
                                if (ss_stus.contains("1")) {
                                    ...
                                    mBottomSheetDialog = BottomSheetDialog(contextt as PlayerChVid)
                                    mBottomSheetDialog!!.setContentView(bottomSheetLayout!!)
                                    mBottomSheetDialog!!.show()
                                } else if (ss_stus != null) {
                                    if (ss_stus.contains("0")) {
                                        rankDialog =
                                            Dialog(this@PlayerChVid, R.style.FullHeightDialog)
            ...
            ll_report_vid?.setOnClickListener(View.OnClickListener { v: View? ->
                rankDialog = Dialog(this@PlayerChVid, R.style.FullHeightDialog)
            ...
            ?.enqueue(object : GlobalCallback<String?>(channel_name11) {
                override fun onResponse(call: Call<String?>, response: Response<String?>) {
                    ...
                    manager?.setPreferences(
                        this@PlayerChVid, Constants.VIDEO_SAVEEE,
                        saved_vid_res!!
                    )
                    if (saved_vid_res!!.contains("1")) {
                        // successful
                        Toast.makeText(this@PlayerChVid, "Video is saved!!", Toast.LENGTH_SHORT)
                            .show()
                        ll_savedd_vid?.visibility = (View.VISIBLE)
                        ll_save_vid?.visibility = (View.GONE)
...
//                                    cfPaymentService.doPayment(PlayerChVid.this, params, token, "PROD", "#174778", "#FFFFFF", false);
////                                    Intent intentpay = new Intent(PlayerHome.this, PlayerHome.class);
////                                    startActivity(intentpay);
//
//                                } else {
//                                    Toast.makeText(PlayerChVid.this, "msg2" + response.body().getMessage(), Toast.LENGTH_SHORT).show();
//                                }
//                            } else {
//                                Toast.makeText(PlayerChVid.this, "msg3" + response.body().getMessage(), Toast.LENGTH_SHORT).show();
//                            }
//
//
//                        } catch (Exception e) {
...
//                                Intent intent = new Intent(PlayerHome.this, PlayerHome.class);
//                                startActivity(intent);
//                                finish();
                    }
                } catch (e: Exception) {
...
//                        rl_cbl.visibility = (View.GONE);
                    ...
                    try {
                        ...
                        if (catggryList != null) {
                            if (catggryList.isEmpty()) {
                                ...
                                adapter_vids_list =
                                    RelVidListAdapter(catggryList, this@PlayerChVid)
    ...
    //                                rv_all_videos.visibility = (View.GONE);//                        blur_reg1.visibility = (View.GONE);
        ...
        RetrofitClient.getClient().hitsuppportt(chh_iddstr, "application/json", "Bearer $token")
            ?.enqueue(object : GlobalCallback<SupporrtPojo?>(title) {
                ...
                override fun onResponse(
                    ...
                    if (res != null) {
                        manager?.setPreferences(this@PlayerChVid, Constants.SUPPORT_HIT, res)
                    }
                    if (res != null) {
                        if (res.contains("2")) {
