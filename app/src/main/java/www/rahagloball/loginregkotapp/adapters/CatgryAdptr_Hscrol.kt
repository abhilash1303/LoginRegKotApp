...
class CatgryAdptr_Hscrol(allFollowList: List<DataItem>, act: HomeDemoActivityCtgry) :
    RecyclerView.Adapter<CatgryAdptr_Hscrol.ViewHolder>() {
    ...
    //    public CatgryAdptr_Hscrol(List<DataItem> allFollowList, Catgryctivity act) {
    ...
    override fun onCreateViewHolder(
        ...
        val view: View = LayoutInflater.from(viewGroup.getContext())
            .inflate(R.layout.home_single_item_hs, viewGroup, false)
