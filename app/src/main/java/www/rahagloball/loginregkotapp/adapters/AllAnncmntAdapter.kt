...
class AllAnncmntAdapter(dataSet: List<AllAnnouncmnt>, mContext: Activity) :
    RecyclerView.Adapter<AllAnncmntAdapter.ViewHolder>() {
    var dataSet: List<AllAnnouncmnt>
    ...
    override fun onBindViewHolder(viewHolder: ViewHolder, i: Int) {
        ...
        ++counter
        val ques_txt_str = counter.toString() + ") " + dataSet[i].announsment
