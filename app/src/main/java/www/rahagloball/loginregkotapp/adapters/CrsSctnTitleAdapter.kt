...
import www.rahagloball.loginregkotapp.activities.courses.TCourseAddVideos
import www.rahagloball.loginregkotapp.models.sectiontile.SectionTitle

class CrsSctnTitleAdapter(allFollowList: List<SectionTitle>, act: FragmentActivity) :
    RecyclerView.Adapter<CrsSctnTitleAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(viewHolder: ViewHolder, i: Int) {
        ...
        vids_crs.setOnClickListener(View.OnClickListener { v: View? ->
            ...
            val intent = Intent(mContext, TCourseAddVideos::class.java)
